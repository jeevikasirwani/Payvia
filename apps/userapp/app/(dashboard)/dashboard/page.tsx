...
async function getBalance() {
  ...
  if (!userId) {
    // Don't run the query if no userId
    return null;
  }
...
export default async function DashboardPage() {
  ...
  return (
    <div className={`${jetbrainsMono.className}  bg-gradient-to-tr from-indigo-200 via-blue-50 to-violet-200 min-h-screen pt-10`}>
     
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800">
            <span className="text-indigo-600">PayVia </span>Dashboard
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <div className="pt-1">
                <a
                  href="/p2p"
                  className="bg-gradient-to-r from-indigo-400 to-indigo-600 text-lg font-medium = hover:from-indigo-500 hover:to-indigo-700 text-white px-3 py-3 rounded-lg transition-colors"
                >
                  Send Money
                </a>
              </div>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Top up your Payvia wallet easily.
              </p>
              <div className="pt-1">
                <a
                  href="/transfer"
                  className="bg-gradient-to-r from-indigo-400 to-indigo-600 text-lg font-medium hover:from-indigo-500 hover:to-indigo-700 text-white px-4 py-3 rounded-lg transition-colors"
                >
                  Add Money
                </a>
              </div>
