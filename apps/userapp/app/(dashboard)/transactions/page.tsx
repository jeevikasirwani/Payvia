...
export const metadata: Metadata = {
  ...
  description:
    "Track all your transactions effortlessly with Flowpay digital wallet application",
};
...
export default async function TransactionsPage() {
  ...
  return (
    <div className={`${jetbrainsMono.className} bg-gradient-to-tr from-indigo-200 via-blue-50 to-violet-200 min-h-screen pb-10  w-full px-4 sm:px-6 lg:px-8`}>
      <div className="flex justify-center md:text-4xl pt-20 font-extrabold">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800">
          <span className="text-indigo-600">Payvia </span>Transactions
        </h1>
      </div>
      ...
      <div className="flex flex-col gap-5">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 px-4 md:px-10 gap-3">
          <h1 className="text-2xl text-slate-800 pt-2 font-bold col-span-1 md:col-span-2">
            <span className="text-indigo-600">P2P </span>Transactions
          </h1>
          <div>
            <OnRampTransaction
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 px-4 md:px-10 gap-3">
          <h1 className="text-2xl text-slate-800 pt-2 font-bold col-span-1 md:col-span-2">
            <span className="text-indigo-600">Wallet </span>Transactions
          </h1>
          <div>
            <OnRampTransaction
